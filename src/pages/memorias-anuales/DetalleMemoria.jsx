import { ArrowLeft, Download, FileText, Users, Calendar, Shield, BookOpen, Trash2 } from "lucide-react";
    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-900">{memoria.name || `Memoria Anual ${memoria.year}`}</h1>
      ...
      <div className="bg-white rounded-lg border border-gray-200 mb-6">
        <div className="px-6 py-4 border-b border-gray-200">
          <div className="flex items-center justify-between">
            ...
            <span className="text-sm text-gray-500">{trabajosPublicados.length} trabajos</span>
          </div>
        </div>
        ...
        <div className="p-6">
          {trabajosPublicados.length === 0 ? (
            <div className="text-center py-8 text-gray-500">
              ...
              <p className="text-sm">Esta memoria aún no tiene trabajos asociados.</p>
            </div>
          ) : (
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-4 mt-2">
                        <span className="bg-gray-100 text-gray-700 px-2 py-1 rounded text-xs">
                          {trabajo.type === 'article' ? 'Artículo' : trabajo.type === 'book' ? 'Libro' : trabajo.type === 'book_chapter' ? 'Capítulo de libro' : trabajo.type}
                        </span>
      ...
      <div className="bg-white rounded-lg border border-gray-200 mb-8">
        <div className="px-6 py-4 border-b border-gray-200">
          <div className="flex items-center justify-between">
            ...
            <span className="text-sm text-gray-500">{registrosPatentes.length} registros</span>
          </div>
        </div>
        ...
        <div className="p-6">
          {registrosPatentes.length === 0 ? (
            <div className="text-center py-8 text-gray-500">
              ...
              <p className="text-sm">Esta memoria aún no tiene patentes asociadas.</p>
            </div>
          ) : (
            <div className="space-y-4">
                ...
                <div key={registro.id} className="border border-gray-200 rounded-lg p-4">
                  <div className="flex justify-between items-start">
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-600 mt-1">{registro.code} • {registro.organization || registro.type}</p>
                    </div>
                  </div>
                </div>
              ))}
